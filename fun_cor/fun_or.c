...
static void     fun_or_reg_reg(t_main *main, t_process *proc)
{
    int     num_reg_1;
    int     num_reg_2;
    int     num_reg_3;
...
static void     fun_or_reg_dir(t_main *main, t_process *proc)
{
    int     num_reg_1;
    int     num_reg_3;
    int     res;
...
static void     fun_or_reg_ind(t_main *main, t_process *proc)
{
    int         num_reg_1;
    int         num_reg_3;
    short int   short_ind;
...
static void     fun_or_dir_reg(t_main *main, t_process *proc)
{
    int         num_reg_2;
    int         num_reg_3;
...
static void     fun_or_dir_dir(t_main *main, t_process *proc)
{
    int         num_reg_3;
...
static void     fun_or_dir_ind(t_main *main, t_process *proc)
{
    int         num_reg_3;
    short int   short_ind;
...
static void     fun_or_ind_reg(t_main *main, t_process *proc)
{
    int         num_reg_2;
    int         num_reg_3;
    short int   short_ind;
...
static void     fun_or_ind_dir(t_main *main, t_process *proc)
{
    int         num_reg_3;
    short int   short_ind;
...
static void     fun_or_ind_ind(t_main *main, t_process *proc)
{
    int         num_reg_3;
